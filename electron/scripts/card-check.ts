...
import { applyCharacterCard } from "@core/cards/apply";
import { autoCar } from "@core/cards/autocar";
import { importTavernCard, importTavernText } from "@core/cards/import";
import { parseTavernJson, parseTavernPng } from "@core/cards/parse";
import { CARD_CAPABILITY } from "@core/cards/types";
import { initialState } from "@core/engine/state";
import { stateHash } from "@core/engine/runtime";

const fixtures = join(import.meta.dir, "../content/cards/fixtures");
